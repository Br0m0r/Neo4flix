...
- [ ] **Step 1: Write the runbook structure**
...
- [ ] **Step 2: Add exact safe commands**
...
- [ ] **Step 3: Record the fixture contract**
...
- [ ] **Step 4: Add the focused verification command**

Document `.\mvnw.cmd -pl database/migrator -am -Dtest=AuditSeedLoaderIT test` as the fixture/loader proof, with expected result `1 test, 0 failures`. Do not invent a local Compose result; leave the batch audit to record the actual run.
...
- [ ] **Step 1: Document the graph shape**
...
- [ ] **Step 2: Add parameterized count and relationship queries**
...
- [ ] **Step 3: Explain the collaborative query**
...
- [ ] **Step 4: Add an evidence checklist**
...
- [ ] **Step 1: Map fixture personas to cold-start states**
...
- [ ] **Step 2: Explain each signal and bound**
...
- [ ] **Step 3: Explain exclusion and filters**
...
- [ ] **Step 4: Map reason text and privacy boundaries**
...
- [ ] **Step 5: Verify source alignment**
...
.\mvnw.cmd -pl backend/recommendation-service -am -Dtest=RecommendationGoldenFixtureIT test
```

Record exact test counts and any environment skip; do not substitute a prior run.
...
- [ ] **Step 4: Update handoff metadata**
