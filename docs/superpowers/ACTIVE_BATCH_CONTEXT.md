...
| Active — next dispatch | Task 6 live acceptance/evidence/status | First genuinely unfinished workstream. It records fresh evidence; Batch 1 remains `[ ]` until the Task 6 and final whole-branch reviews pass. |
